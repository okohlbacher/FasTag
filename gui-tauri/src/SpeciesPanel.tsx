  ...
  return (
    <div className="species">
        ...
        <table className="taxa">
          ...
          <tbody>
            {report.taxa.map((t: Taxon) => {
              ...
              // Hits relative to the top taxon: a relative confidence that this
              // is the taxon, normalised so the highest-hitting one is 100%.
              const rel = Math.round((t.observed / maxObs) * 100)
              return (
                <tr key={t.taxid}>
                  <td>
                    <button
                  ...
                  <td className="num bar-cell" title="spectral hits relative to the top taxon">
                    <span className="minibar" style={{ width: `${rel}%` }} />
      ...
      <p className="footnote">
        ...
        per-k-mer background is a proxy and the chimeric-null problem applies. ⚑ marks genera common
        to most runs as reagents.
      </p>
    </div>
  )
}
